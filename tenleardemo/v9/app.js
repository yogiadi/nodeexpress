...
// mongoose.connect("mongodb://localhost/ten_lear_v12");
mongoose.connect("mongodb://yogiadi:password@ds121483.mlab.com:21483/tenleardemo");
...
app.listen(process.env.PORT, process.env.IP, function(){
   console.log("The Tenlear Server Has Started!");
});
